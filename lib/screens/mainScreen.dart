import 'package:chattest/add_image/addImage.dart';
import 'package:chattest/config/palette.dart';
...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
  ...
  void _tryValidation(){
    //모든 Form의 Validator 값을 가져올 수 있음
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          text: TextSpan(
                            ...
                            children: [
                              TextSpan(
                                text: isSignupScreen ? ' to Small Talk' : ' back',
                                style: TextStyle(
                                   letterSpacing: 1.0,
                                   fontSize: 25,
                                   color: Colors.white,
                          ...
                          Text(
                            isSignupScreen ? 'Singup to continue' : 'Singin to continue',
                            style: TextStyle(
                                letterSpacing: 1.0,
                                color: Colors.white
                            ),
